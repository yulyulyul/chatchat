...
class update_profile_pathTophp extends AsyncTask<Void, Integer , Void>{
	...
	public update_profile_pathTophp(String uri,String _id, String _path) 
	{
		this.server_uri = uri;
		this.id = _id;
		this.path = _path;
...
//		}
	...
	protected void onPreExecute() {
		...
		//System.out.println("In update_profile_pathTophp onPreExecute");
	...
	protected Void doInBackground(Void... params) {
		//System.out.println("In update_profile_pathTophp doInBackground");
